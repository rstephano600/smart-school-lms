    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-xl p-4 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <i class="fas fa-pen-alt text-blue-500 text-2xl"></i>
            </div>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-600"><?php echo $stats['upcoming_exams']; ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-yellow-600"><?php echo $stats['pending_grading']; ?></p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-500 to-purple-600 p-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="px-2 py-1 text-xs rounded-full <?php echo $status_color; ?> bg-white bg-opacity-20 text-white">
                                <?php echo $status; ?>
                            </span>
                        </div>
                    </div>
                    <div class="p-4">
                        ...
                        <div class="flex justify-end space-x-2 mt-4 pt-3 border-t">
                            <a href="edit.php?id=<?php echo $exam['id']; ?>" class="text-blue-600 hover:text-blue-800 p-1" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="questions.php?id=<?php echo $exam['id']; ?>" class="text-green-600 hover:text-green-800 p-1" title="Add Questions">
                            ...
                            <a href="analytics.php?id=<?php echo $exam['id']; ?>" class="text-yellow-600 hover:text-yellow-800 p-1" title="Analytics">
                                <i class="fas fa-chart-line"></i>
                            </a>
                            <a href="delete.php?id=<?php echo $exam['id']; ?>" onclick="return confirm('Delete this exam?')" class="text-red-600 hover:text-red-800 p-1" title="Delete">
